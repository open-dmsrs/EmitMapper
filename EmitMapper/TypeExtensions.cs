...
#endif
{
  public static class TypeExtensions
  {
    ...
    {
      if (Creators.ContainsKey(@this)) return Creators[@this];

      lock (Creators)
      {
        if (Creators.ContainsKey(@this)) return Creators[@this];
        return Creators.GetOrAdd(
          @this,
  ...
  public static class TypeHome
  {
    ...
    /// <summary>
    /// </summary>
    public static readonly Type Int16 = Meta<short>.Type;

    public static readonly Type Short = Int16;

    /// <summary>
    /// </summary>
    public static readonly Type Int32 = Meta<int>.Type;

    public static readonly Type Int = Int32;

    /// <summary>
    /// </summary>
    public static readonly Type Int64 = Meta<long>.Type;

    public static readonly Type Long = Int64;

    /// <summary>
    /// </summary>
    public static readonly Type UInt64 = Meta<ulong>.Type;

    public static readonly Type ULong = UInt64;

    /// <summary>
    /// </summary>
    public static readonly Type Single = Meta<float>.Type;

    public static readonly Type Float = Single;

    /// <summary>
    /// </summary>
    public static readonly Type UInt32 = Meta<uint>.Type;
    ...
    ///   Type UInt16
    /// </summary>
    public static readonly Type UInt16 = Meta<ushort>.Type;
    ...
    /// <summary>
    /// </summary>
    public static readonly Type Boolean = Meta<bool>.Type;
  ...
  {
    //private static Lazy<T,Type> lazy = new Lazy<T, Meta<T>>();
  ...
  internal class B
  {
    ...
    private void M()
    {
      var methodInfo = Meta<B>.Method(b => (Func<int, int, int>)((i, i1) => b.Test(i, i1)));
    }
  }
}