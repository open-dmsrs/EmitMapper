...
namespace EmitObjectMapper.Mappers
{
    ...
    {
        private new readonly MethodInvokerFunc_1 _converter = null;
            ...
            : base(mapperMannager, TypeFrom, TypeTo, mappingConfigurator, null)
        {
            ...
            After:
                        ...
                        var from = TypeFrom == typeof(IEnumerable) ? typeof(object) : TypeFrom;
            */
            Type to = TypeTo == typeof(IEnumerable) ? typeof(object) : TypeTo;
            Type from = TypeFrom == typeof(IEnumerable) ? typeof(object) : TypeFrom;
            ...
            After:
                        ...
                        var converterMethod = staticConv.GetStaticConverter(from, to);
            */
            StaticConvertersManager staticConv = mappingConfigurator.GetStaticConvertersManager() ?? StaticConvertersManager.DefaultInstance;
            System.Reflection.MethodInfo converterMethod = staticConv.GetStaticConverter(from, to);
