...
public static class FastReflection
{
  ...
  public static void GenDebugAssembly<TTarget>(string name, FieldInfo field, PropertyInfo property, MethodInfo method, Type targetType, Type[] ctorParamTypes)
  {
    ...
    var curAssemblyName = Assembly.GetAssembly(Metadata<ILEmitter>.Type)?.GetName();

    if (curAssemblyName != null)
    {
      asmName.SetPublicKey(curAssemblyName.GetPublicKey());
      asmName.SetPublicKeyToken(curAssemblyName.GetPublicKeyToken());
    }
