...
public class NullableConverter
{
	...
	{
		return par is null ? default(bool?) : Convert.ToBoolean(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(byte?) : Convert.ToByte(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(byte?) : byte.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(char?) : Convert.ToChar(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(DateTime?) : Convert.ToDateTime(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(DateTime?) : DateTime.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(decimal?) : Convert.ToDecimal(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(decimal?) : decimal.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(double?) : Convert.ToDouble(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(double?) : double.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(short?) : Convert.ToInt16(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(short?) : short.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(int?) : Convert.ToInt32(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return string.IsNullOrEmpty(par) ? default(int?) : int.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(long?) : Convert.ToInt64(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(long?) : long.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(sbyte?) : Convert.ToSByte(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(sbyte?) : sbyte.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(float?) : Convert.ToSingle(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(float?) : float.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par?.ToString(CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(ushort?) : Convert.ToUInt16(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(ushort?) : ushort.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(uint?) : Convert.ToUInt32(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(uint?) : uint.Parse(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(ulong?) : Convert.ToUInt64(par, CultureInfo.InvariantCulture);
	}
	...
	{
		return par is null ? default(ulong?) : ulong.Parse(par, CultureInfo.InvariantCulture);
	}
